...
const getAcceptedDonors = (seeker) => {
  return new Promise((resolve, reject) => {
    connection.query("select * FROM notification left outer join donor on notification.donor_username=donor.username WHERE seeker_username=? and status=?", [
...
module.exports = {
  addNewSeeker, getSeeker, getDonors, getAcceptedDonors, updateDetails
};
